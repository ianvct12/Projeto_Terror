...
public class IlhaDaMorte extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IlhaDaMorte frame = new IlhaDaMorte();
	...
	public IlhaDaMorte() {
		...
		p1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				model.Pergunta p = controlePergunta.consultarPergunta(11);
		...
		p1.setBounds(78, 866, 107, 23);
		getContentPane().add(p1);
		
		JButton p3 = new JButton("Pergunta 3");
		p3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				model.Pergunta p = controlePergunta.consultarPergunta(13);
		...
		p3.setBounds(332, 866, 107, 23);
		getContentPane().add(p3);
		
		JButton p5 = new JButton("Pergunta 5");
		p5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				model.Pergunta p = controlePergunta.consultarPergunta(15);
		...
		p5.setBounds(582, 866, 107, 23);
		getContentPane().add(p5);
		
		JButton p4 = new JButton("Pergunta 4");
		p4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				model.Pergunta p = controlePergunta.consultarPergunta(14);
		...
		p4.setBounds(462, 866, 107, 23);
		getContentPane().add(p4);
		
		JButton p2 = new JButton("Pergunta 2");
		p2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				model.Pergunta p = controlePergunta.consultarPergunta(12);
		...
		lblNewLabel.setIcon(new ImageIcon(IlhaDaMorte.class.getResource("/Imagens/ilhadacaveira.gif")));
